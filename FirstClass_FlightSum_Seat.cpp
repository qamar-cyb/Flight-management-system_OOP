...
void Firstclass :: flightSummery(int flight_price)
{
    system("cls");
...
void Firstclass :: flightSummery_for_multiCity(int flight_price)
{
    system("cls");
...
void Firstclass :: flightSummery_for_seatSelector(string seatNumber, int ticket_price)
{
    system("cls");
...
void Firstclass :: flightSummery_for_seatSelector_multiCity(string seatNumber, int ticket_price)
{
     system("cls");
...
string Firstclass :: seatSelection()
{
    system("cls");
    cout << "---------------------------------\n";
