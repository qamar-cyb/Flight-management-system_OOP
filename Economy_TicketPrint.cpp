...
void Economy :: printTicket(int flight_price)
{
    ofstream outFile;
...
void Economy :: printTicket_for_multiCity(int flight_price)
{
...
void Economy :: printTicket_for_seatSelector(string seatNumber, int ticket_price)
{
    ofstream outFile;
...
void Economy :: printTicket_for_seatSelector_multyCity(string seatNumber, int ticketprice)
{
