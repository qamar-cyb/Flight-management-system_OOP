...
void Bussiness :: selectTheFires(string date_of_travel, string stops, int ticket_price)
{
    system("cls");
    
    cout << "------------------X-------------------\n";
    cout << "| SELECT THE FARES FOR BUSSINESS CLASS |\n";
    cout << "------------------X-------------------\n\n\n";

    cout << "1)-----------------------------\n";
    cout << "| Flight Type    :  " << flightype << "\n";
    cout << "| Seat Category  :  BUSSINESS\n";
