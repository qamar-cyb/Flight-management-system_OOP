...
void Economy :: flightSummery(int flight_price)
{
    system("cls");
    ...
    cout << "| Seat Category:  Economy" << endl;
...
void Economy :: flightSummery_for_multiCiy(int flight_price)
{
    system("cls");
...
void Economy :: flightSummery_for_seatSelector(string seatNumber, int ticket_price)
{
    system("cls");
...
void Economy :: flightSummery_for_seatSelector_multiCity(string seatNumber, int ticket_price)
{
     system("cls");
...
string Economy :: seatSelection()
{
    system("cls");
    cout << "---------------------------------\n";
    cout << "|       ECONOMY CLASS SEATS      |\n";
    cout << "---------------------------------\n";
    cout << "   A   B   C       D   E   F\n";
