...
void Bussiness :: PassengerData_for_one_return_way(string a,string b,string c,string d,string e,string f,int g,int h,int i,string j)
{
...
void Bussiness :: PassengerData_for_multiCity(string a,string b,string c,string d,string e,string f,string g,string h,string i,int j,int k,int l,string m)
{
    departure_city_name_1 = a;
    destination_city_name_1 = b;
...
void Bussiness :: selectTicket_for_one_return_way()
{
    system("cls");
...
void Bussiness :: selectTicket_for_multiCity()
{
